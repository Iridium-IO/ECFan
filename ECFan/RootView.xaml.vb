Public Class RootView
    ...
    Dim currentActivateState = True

    Private Sub RootView_StateChanged(sender As Object, e As EventArgs) Handles Me.StateChanged
        If Me.WindowState = WindowState.Minimized Then
            currentActivateState = BaseTimer.Enabled
            BaseTimer.Enabled = False
        Else
            BaseTimer.Enabled = currentActivateState
        End If
    End Sub
